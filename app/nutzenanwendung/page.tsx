...
export default function NutzenAnwendungPage() {
  return (
    <>
      {/* Hero */}
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '4rem 1.5rem 3rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'start' }} className="section-grid">
          ...
          <div style={{ position: 'relative', aspectRatio: '4/3', borderRadius: '12px', overflow: 'hidden' }}>
            <Image src="/images/dollar.webp" alt="Nutzen und Anwendung" fill style={{ objectFit: 'cover' }} />
          </div>
          {/* Title + Q&A right */}
          <div>
            <h1 style={{ fontSize: '48px', fontWeight: 700, margin: '0 0 1.5rem' }}>
              <span className="text-brand">Nutzen</span><span className="text-blue">&amp;</span><span className="text-brand">Anwendung.</span>
            </h1>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <div>
                <p style={{ color: '#ffffff', fontSize: '20px', fontWeight: 700, fontFamily: 'var(--font-syne)', margin: '0 0 0.5rem' }}>Was ist das?</p>
                <p style={{ color: '#ffffff', fontSize: '18px', lineHeight: '1.75', fontFamily: 'var(--font-syne)', margin: 0 }}>Die strukturierte Auswahl von KI-Anwendungsfällen mit Fokus auf Wirtschaftlichkeit, Umsetzbarkeit und Datenschutz.</p>
              </div>
              <div>
                <p style={{ color: '#ffffff', fontSize: '20px', fontWeight: 700, fontFamily: 'var(--font-syne)', margin: '0 0 0.5rem' }}>Was machen wir?</p>
                <p style={{ color: '#ffffff', fontSize: '18px', lineHeight: '1.75', fontFamily: 'var(--font-syne)', margin: 0 }}>Wir analysieren Prozesse, identifizieren Potenziale und bewerten Ideen anhand erprobter Kriterien (Nutzen, Risiko, Reifegrad). Ergebnis ist eine Shortlist konkreter Use Cases – praxisnah, datenschutzkonform und mit echtem Mehrwert.</p>
              </div>
              <div>
                ...
                <p style={{ color: '#ffffff', fontSize: '18px', lineHeight: '1.75', fontFamily: 'var(--font-syne)', margin: 0 }}>Jedes Unternehmen hat andere Prozesse, Ziele und Rahmenbedingungen. Deshalb erfolgt die Auswahl immer auf Basis eines gemeinsamen Workshops und abgestimmt auf die tatsächliche Organisation.</p>
              </div>
              <div>
                <p style={{ color: '#ffffff', fontSize: '20px', fontWeight: 700, fontFamily: 'var(--font-syne)', margin: '0 0 0.5rem' }}>Was bringen wir mit?</p>
                <p style={{ color: '#ffffff', fontSize: '18px', lineHeight: '1.75', fontFamily: 'var(--font-syne)', margin: 0 }}>– Branchenmuster &amp; Use Case-Bibliothek<br />– Bewertungsmodelle &amp; Scoring-Vorlagen<br />– Erfahrung aus vergleichbaren Projekten</p>
              </div>
              <div>
                ...
                <p style={{ color: '#ffffff', fontSize: '18px', lineHeight: '1.75', fontFamily: 'var(--font-syne)', margin: 0 }}>Viele Unternehmen verlieren Zeit in endlosen Ideensammlungen oder stürzen sich in Hype-Themen ohne echten Nutzen. Unsere strukturierte Methode vermeidet Blindflüge und liefert schnell umsetzbare Ergebnisse – fundiert statt zufällig.</p>
              </div>
